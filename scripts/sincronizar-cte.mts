/**
 * Dispara a captura de CT-e de um cliente pela linha de comando.
 *
 ...
 *
 *   npx tsx scripts/sincronizar-cte.mts --cnpj 49039801000150 --lotes 1
 */
...
} from "../app/lib/sefaz/sincronizarClienteCTe.ts";
...
console.log(`NSU de partida: ${cliente.ultimo_nsu_cte_recebida ?? 0}`);
